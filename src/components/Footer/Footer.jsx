          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-8">
            ...
            <div className="col-span-1">
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-300 hover:text-white">Lo studio</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white">I professionisti</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white">I nostri servizi</a></li>
              </ul>
            </div>
